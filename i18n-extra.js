...
(function() {
  const EXTRA = {
    ...
    ev_arkana_n: { pt:"Arkana Festival · edição 16", en:"Arkana Festival · 16th edition", es:"Arkana Festival · 16ª edición", de:"Arkana Festival · 16. Ausgabe", fr:"Arkana Festival · 16ᵉ édition", ja:"Arkana Festival · 第16回" },
    ev_arkana_lu:{ pt:"<b>Lineup confirmado:</b> Mallki · Tekmall · convidados Padang · Vale Sagrado dos Incas", en:"<b>Confirmed lineup:</b> Mallki · Tekmall · Padang guests · Sacred Valley of the Incas", es:"<b>Lineup confirmado:</b> Mallki · Tekmall · invitados Padang · Valle Sagrado de los Incas", de:"<b>Bestätigtes Lineup:</b> Mallki · Tekmall · Padang-Gäste · Heiliges Tal der Inka", fr:"<b>Lineup confirmé :</b> Mallki · Tekmall · invités Padang · Vallée Sacrée des Incas", ja:"<b>確定ラインナップ：</b> Mallki · Tekmall · Padang ゲスト · インカの聖なる谷" },
    ...
    ev_blacklite_n: { pt:"Padang × Blacklite · próxima edição", en:"Padang × Blacklite · next edition", es:"Padang × Blacklite · próxima edición", de:"Padang × Blacklite · nächste Ausgabe", fr:"Padang × Blacklite · prochaine édition", ja:"Padang × Blacklite · 次回" },
    ev_blacklite_lu:{ pt:"<b>A confirmar:</b> Alex Alipe (EP.21 Lab) gravado na edição anterior · mais artistas da casa", en:"<b>To be confirmed:</b> Alex Alipe (Lab EP.21) recorded at the previous edition · more house artists", es:"<b>A confirmar:</b> Alex Alipe (EP.21 Lab) grabado en la edición anterior · más artistas de la casa", de:"<b>Noch zu bestätigen:</b> Alex Alipe (Lab EP.21) aufgenommen bei der vorherigen Ausgabe · weitere House-Künstler", fr:"<b>À confirmer :</b> Alex Alipe (Lab EP.21) enregistré à l'édition précédente · plus d'artistes maison", ja:"<b>確認予定：</b> 前回録音された Alex Alipe (Lab EP.21) · その他のハウスアーティスト" },
    ev_blacklite_loc:{ pt:"a confirmar", en:"to be confirmed", es:"a confirmar", de:"noch zu bestätigen", fr:"à confirmer", ja:"確認予定" },
    ...
    ev_sync_n: { pt:"Syncronic · Padang × Blacklite", en:"Syncronic · Padang × Blacklite", es:"Syncronic · Padang × Blacklite", de:"Syncronic · Padang × Blacklite", fr:"Syncronic · Padang × Blacklite", ja:"Syncronic · Padang × Blacklite" },
    ev_sync_lu:{ pt:"<b>Set:</b> Alex Alipe — gravado e lançado como EP.21 da Lab Series", en:"<b>Set:</b> Alex Alipe — recorded and released as Lab Series EP.21", es:"<b>Set:</b> Alex Alipe — grabado y lanzado como EP.21 de la Lab Series", de:"<b>Set:</b> Alex Alipe — aufgenommen und als Lab Series EP.21 veröffentlicht", fr:"<b>Set :</b> Alex Alipe — enregistré et sorti en tant que Lab Series EP.21", ja:"<b>セット：</b> Alex Alipe — 録音され Lab Series EP.21 としてリリース" },
    ev_sync_loc:{ pt:"collab pad×blkl", en:"collab pad×blkl", es:"collab pad×blkl", de:"collab pad×blkl", fr:"collab pad×blkl", ja:"collab pad×blkl" },

    ev_earth25_n: { pt:"Earthdance 2025", en:"Earthdance 2025", es:"Earthdance 2025", de:"Earthdance 2025", fr:"Earthdance 2025", ja:"Earthdance 2025" },
    ev_earth25_lu:{ pt:"<b>Sets:</b> Dienstmann vs Vorg (b2b, gravado como EP.18) · Tekmall (set completo, gravado)", en:"<b>Sets:</b> Dienstmann vs Vorg (b2b, recorded as EP.18) · Tekmall (full set, recorded)", es:"<b>Sets:</b> Dienstmann vs Vorg (b2b, grabado como EP.18) · Tekmall (set completo, grabado)", de:"<b>Sets:</b> Dienstmann vs Vorg (b2b, aufgenommen als EP.18) · Tekmall (komplettes Set, aufgenommen)", fr:"<b>Sets :</b> Dienstmann vs Vorg (b2b, enregistré en tant qu'EP.18) · Tekmall (set complet, enregistré)", ja:"<b>セット：</b> Dienstmann vs Vorg (b2b、EP.18として録音) · Tekmall (フルセット、録音済)" },
    ev_earth25_loc:{ pt:"earthdance brasil", en:"earthdance brazil", es:"earthdance brasil", de:"earthdance brasilien", fr:"earthdance brésil", ja:"earthdance ブラジル" },
    ...
    ev_modem_lu:   { pt:"<b>Datas:</b> 03 — 09 ago · gates 01 ago · <b>Palcos prováveis Padang:</b> The Swamp · <b>Lineup completo:</b> TBA · artistas Padang com certeza presentes",
                     en:"<b>Dates:</b> 03 — 09 Aug · gates 01 Aug · <b>Likely Padang stages:</b> The Swamp · <b>Full lineup:</b> TBA · Padang artists confirmed to attend",
                     es:"<b>Fechas:</b> 03 — 09 ago · gates 01 ago · <b>Escenarios probables Padang:</b> The Swamp · <b>Line-up completo:</b> TBA · artistas Padang con seguridad presentes",
                     de:"<b>Daten:</b> 03. — 09. Aug · Gates 01. Aug · <b>Wahrscheinliche Padang-Stages:</b> The Swamp · <b>Komplettes Lineup:</b> TBA · Padang-Künstler sicher anwesend",
                     fr:"<b>Dates :</b> 03 — 09 août · gates 01 août · <b>Scènes Padang probables :</b> The Swamp · <b>Lineup complet :</b> TBA · artistes Padang assurément présents",
                     ja:"<b>日程：</b> 8月3〜9日 · gates 8月1日 · <b>Padang 出演予想ステージ：</b> The Swamp · <b>全ラインナップ：</b> 未定 · Padang アーティスト出演確定" },
    ...
    ev_up_lu:      { pt:"<b>Palco:</b> Tropikalien · <b>Lineup:</b> TBA",
                     ...
                     es:"<b>Escenario:</b> Tropikalien · <b>Line-up:</b> TBA",
                     de:"<b>Stage:</b> Tropikalien · <b>Lineup:</b> TBA",
                     fr:"<b>Scène :</b> Tropikalien · <b>Lineup :</b> TBA",
                     ja:"<b>ステージ：</b> Tropikalien · <b>ラインナップ：</b> 未定" },
    ev_up_loc:     { pt:"brasil · universo paralello · réveillon", en:"brazil · universo paralello · new year's eve", es:"brasil · universo paralello · año nuevo", de:"Brasilien · Universo Paralello · Silvester", fr:"brésil · universo paralello · réveillon", ja:"ブラジル · Universo Paralello · 大晦日" },
